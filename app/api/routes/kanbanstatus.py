...
def create_kanban_status(kanban_status: KanbanStatusCreate, db: Session = Depends(get_db)):
    ...
    return kanban_status_crud.create(kanban_status)
...
def update_kanban_status(id: int, kanban_status: KanbanStatusUpdate, db: Session = Depends(get_db)):
    kanban_status_crud = KanbanStatusCRUD(db)
    kanban_status_crud.update(id, kanban_status)
